...
<div id="home" class="div-copertina new-app-main-banner-area align-items-center" style="min-height: 550px; background-image:url('{{ Storage::url('public/tenant/demo/profilo/copertina.jpg')}}');">
    ...
    <div class="container text-center text-md-left" >
        <div class="header-copertina mt-2 mt-md-5">
            ...
            <p class="sottotitolo-1">Provalo ora!</p>
            <div class="my-3">
                <a class="btn btn-orange bordotondomolto text-uppercase p-2 px-3 mr-2" target="blank" href="https://demo.radicando.it/">Pagina ordini</a>
                <a class="btn btn-orange bordotondomolto text-uppercase p-2 px-3 " target="blank" href="https://demo.radicando.it/login">Demo gestionale</a>
            </div>
        </div>
    </div>
